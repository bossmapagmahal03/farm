    ...
    <div id="loginPage" class="login-container">
        <div class="login-box">
            <div class="login-logo">
                <img src="farm.png" alt="Farm Logo" width="350">
            </div>
            <h1>Moonlight Farm</h1>
            <p class="login-subtitle">Munlawin, San Nicolas Batangas</p>
        ...
        <main class="main-content">
            ...
            <header class="top-header">
                <div class="header-left">
                    ...
                    <p id="pageSubtitle">Welcome back to Moonlight Farm</p>
                </div>
                    ...
                    <div class="stats-grid">
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                ...
                                <p class="stat-change">↑ 10 Livestock</p>
                            </div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon"></div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-content">
                                ...
                                <p class="stat-change">Reorder soon</p>
                            </div>
                        </div>
                        <div class="stat-card">
                            <div class="stat-icon"></div>
...
class FarmSystem {
        ...
        livestockTable.innerHTML = this.livestock.map(animal => `
            <tr>
                ...
                <td><button class="btn-text" onclick="farmSystem.viewAnimalDetails('${animal.id}')">View</button></td>
                 <td>
                <button class='btn-primary' onclick='editLivestock({$row['id']})'>Edit</button>
                <button class='btn-danger' onclick='deleteLivestock({$row['id']})'>Delete</button>
            </td>
            </tr>
        `).join('');
    ...
    populateProductionData() {
        const stats = [
            { icon: '', title: 'Milk Production', value: '25 L', change: '↑ 5.2% today' },
            { icon: '', title: 'Egg Production', value: '120pcs', change: '↑ 3.1% today' },
